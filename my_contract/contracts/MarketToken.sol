...
contract MarketToken is ERC20, ERC20Burnable, ERC20Pausable, Ownable, ERC20Permit {
    // 添加控制器
    ...
    constructor() ERC20("MarketToken", "MT") Ownable(msg.sender) ERC20Permit("MarketToken") {
        _owner = msg.sender;
